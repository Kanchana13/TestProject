...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+ "/Reports/"+repNmae);
		...
		extent.setSystemInfo("Host Nmae", "Local Host");
		extent.setSystemInfo("QA Name", "Finny");
